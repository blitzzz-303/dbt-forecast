...
def main():
    ...
    connection_parameters = connection_parameters = json.load(open('/dbt/python/snow_session.json'))
    ...
    configs = {'session':session, "tbl_source": "HT_DEV.SNOWPARK.SALES_DATASET_ENHANCED_TRAIN",
                     "tbl_target": "HT_DEV.SNOWPARK.SALES_DATASET_ENHANCED_PREDICT",
                     "_ts_fld":"WEEK_DATE", "_cat_fld":"STORE", "_label_fld": "WEEKLY_SALES"}
